...
class FlaskValidate(object):
    ...
    def init_app(self, app, **kwargs):
        validate_before_request = make_before_request_function(self.schema)
        app.before_request(validate_before_request)
    ...
    def validate_before_request():
        ...
        for route in sorted(schema, reverse=True):
            if try_match(normalized_path, route):
                ...
                status, message = validate_request(request, _path_schema)
